...
import org.example.DisjointSetFunctions;
...
//    }
    ...
    public static int[] analyseImage(Image imageToAnalyse, double hue, double saturation, double brightness,
        ...
        for (int i = 0; i < width*height; i++) {
            ...
            if (((colour.getHue() >= (hue-hueThreshold) || (colour.getHue()+hueThreshold)%360 >= hue)) &&
                    (colour.getHue() <= (hue+hueThreshold) || (colour.getHue()-hueThreshold)%360 <= hue) &&
